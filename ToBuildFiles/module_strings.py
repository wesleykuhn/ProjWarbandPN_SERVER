...
"),
  ...
  ("bring_player_here", "Bring a Player Here"),
  ...
  # PN START ***************************************************************************
  ("trade_route_name_0", "Boston"),
  ("trade_route_name_1", "Savannah"),
  ("trade_route_name_2", "Santos"),
  ("trade_route_name_3", "Calcutta"),
  ("trade_route_name_4", "Cameroons"),
  ("trade_route_name_5", "Tunis"),
  ("trade_route_name_6", "Izmir"),
  ...
  ("reg7_build_gold_cost","Cost: {reg7} Gold"),
  ("sapper_builds_limit", "The amount of sapper buildings, on the map, reached the limit!"),
  
  ("repair_prop","Repair"),
  ("build_prop","Construct"),
  ("dig_prop","Dig"),
  ("undig_prop","Undig"),
  ...
  ("cannot_use_cannon", "Your class does not know how to use use cannons!"),
  ("cannot_use_rocket", "Your class does not know how to use use rockets!"),
  ...
  ("cant_control_cannon_moving", "You cannot control a cannon or rocket while the ship is moving!"),
  ...
  ("menu_neutral", "Voices - Neutral"),
  ("menu_hostile", "Voices - Hostile"),
  ("menu_robbery", "Voices - Robbery"),
  ("anim_stop", "Stop animation"),
  ("anim_cheer", "Cheer"),
  ("anim_sit_ground_1", "Sit on the ground"),
  ("anim_sit_chair", "Sit on chair"),
  ("anim_salute_sword", "Salute Sword"),
  ("anim_cane_idle", "Hold drill cane"),
  ("anim_salute", "Salute"),
  ...
  ("troop_militia_become", "Quickly become {s1} to defend {s2}!"),
  ("troop_cost", "{s0}^Cost: {reg10}"),
  ("troop_strength_agility", "{s0}^Strength: {reg10}^Agility: {reg11}"),
  ("troop_weapon_proficiencies", "{s0}^One handed: {reg10}^Firearms: {reg14}^Polearms: {reg12}^Two handed: {reg15}^Can use cannons? {s12}^Can play musics? {s13}"),
...
Poisonous herbs can also sometimes be found, which are then applied to the blades of certain weapons used for murderous deeds; they have many brown stalks covered in tiny green leaves."),
  ...
  ("castle_name_0", "Paris"),
  ("castle_name_1", "London"),
  ("castle_name_2", "Berlin"),
  ("castle_name_3", "Wien"),
  ("castle_name_4", "Moscow"),
  ("castle_name_5", "Chateau de Tiffauges"),
  ("castle_name_6", "La Roche sur yon"),
  ("castle_name_7", "Cholet"),
  ("castle_name_8", "Angers"),
  ("castle_name_9", "Smolensk"),
  ("castle_name_10", "Leipzig"),
  ("castle_name_11", "Madrid"),
  ("castle_name_12", "Cairo"),
  ("castle_name_13", "Constantinople"),
  ("castle_name_14", "Warszawa"),
  ("castle_name_15", "Friedland"),
  ("castle_name_16", "Copenhagen"),
  ("castle_name_17", "Dublin"),
  ("castle_name_18", "Jerusalem"),
  ("castle_name_19", "Waterloo"),
  ("castle_name_20", "Rome"),
  ("castle_name_21", "Cologne"),
  ("castle_name_22", "Boulogne"),
  ("castle_name_23", "Dover"),
  ("castle_name_24", "Amsterdam"),
  ("castle_name_25", "Frankfurt"),
  ("castle_name_26", "Mainz"),
  ("castle_name_27", "Oasis"),
  ("castle_name_28", "Luxembourg"),
  ("castle_name_29", "Orleans"),
  ("castle_name_30", "Zaragoza"),
  ("castle_name_31", "Barcelona"),
  ("castle_name_32", "Valencia"),
  ("castle_name_33", "Salamanca"),
  ("castle_name_34", "Lisbon"),
  ("castle_name_35", "Toulon"),
  ("castle_name_36", "Elba"),
  ("castle_name_37", "Corsica"),
  ("castle_name_38", "Naples"),
  ("castle_name_39", "Bologna"),
  ...
  ("castle_name_47", "Crimea"),
  ("castle_name_48", "Albania"),
  ("castle_name_49", "Maldovia"),
  ("castle_name_50", "Minsk"),
  ("castle_name_51", "Saint Petersburg"),
  ("castle_name_52", "Milan"),
  ("castle_name_53", "Tyrol"),
  ("castle_name_54", "Konigsberg"),
  ("castle_name_55", "Metz"),
  ("castle_name_56", "Istanbul"),
  ("castle_name_57", "Hanover"),
  ("castle_name_58", "Stuttgart"),
  ("castle_name_59", "Florence"),
  ("castle_name_60", "Varna"),
  ("castle_name_61", "Tunis"),
  ...
  ("api_host_controller", "https://kuhnper.com.br/Development/Controller.php"),
