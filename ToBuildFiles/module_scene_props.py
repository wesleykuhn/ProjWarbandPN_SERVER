...
def spr_bank_deposit_triggers():
  return [(ti_on_scene_prop_use,
   [(store_trigger_param_1, ":agent_id"),
		...
		(player_is_active, ":player_id"),
		(gt, ":player_id", 0),
		(call_script, "script_api_bank_system_call", ":player_id", 2),
    ])] 
...
def spr_bank_withdraw_triggers():
  return [(ti_on_scene_prop_use,
   [(store_trigger_param_1, ":agent_id"),
		...
		(player_is_active, ":player_id"),
		(gt, ":player_id", 0),
		(call_script, "script_api_bank_system_call", ":player_id", 1),
    ])]
...
scene_props = [
  ...
  ("pn_buy_french_carabineer_trumpeter", spr_buy_item_flags(6), "fr_carabineer_trumpeter", "bo_pw_armor_body", spr_buy_item_triggers("itm_fr_carabineer_trumpeter", resources=["itm_linen_cloth", "itm_linen_cloth_small"], tailoring=2)),
  ...
  ("pn_buy_french_cuirassier_body_trumpeter", spr_buy_item_flags(6), "fr_cuirassier_body_trumpeter", "bo_pw_armor_body", spr_buy_item_triggers("itm_fr_cuirassier_body_trumpeter", resources=["itm_linen_cloth", "itm_linen_cloth_small"], tailoring=2)),
  ...
  ("pn_buy_russian_pioneer", spr_buy_item_flags(4), "rus_pioneer", "bo_pw_armor_body", spr_buy_item_triggers("itm_rus_pioneer", resources=["itm_linen_cloth"], tailoring=2)),
  ...
  ("pn_buy_russian_kutuzov_uniform", spr_buy_item_flags(10), "rus_kutuzov", "bo_pw_armor_body", spr_buy_item_triggers("itm_rus_kutuzov_uniform", resources=[("itm_linen_cloth", 2), "itm_copper_piece"], tailoring=2)),
  ...
  ("pn_buy_austrian_infantry_nco_uniform", spr_buy_item_flags(4), "austrian_infantry_nco", "bo_pw_armor_body", spr_buy_item_triggers("itm_austrian_infantry_nco", resources=["itm_linen_cloth"], tailoring=2)),
  ("pn_buy_austrian_infantry_officer_uniform", spr_buy_item_flags(4), "austrian_infantry_officer", "bo_pw_armor_body", spr_buy_item_triggers("itm_austrian_infantry_officer", resources=["itm_linen_cloth"], tailoring=2)),
  ...
  ("pn_buy_austrian_grenzer_officer_uniform", spr_buy_item_flags(4), "austrian_grenzer_officer", "bo_pw_armor_body", spr_buy_item_triggers("itm_austrian_grenzer_officer", resources=["itm_linen_cloth"], tailoring=2)),
  ...
  ("pn_buy_civil_pirate_hat", spr_buy_item_flags(3), "pirate_hat", "bo_pw_armor_head", spr_buy_item_triggers("itm_pirate_hat", resources=["itm_leather_piece"], tailoring=2)),
  #Civil body
  ...
  ("pn_buy_russian_opol_hat_ranker", spr_buy_item_flags(2), "rus_opol_hat", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_opol_hat_ranker", resources=["itm_leather_piece"], tailoring=2)),
  ("pn_buy_russian_opol_hat_officer", spr_buy_item_flags(2), "rus_opol_captain_hat", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_opol_hat_officer", resources=["itm_leather_piece"], tailoring=2)),
  ("pn_buy_russian_pavlovsk_ranker", spr_buy_item_flags(2), "rus_pavlovsk_ranker", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_pavlovsk_ranker", resources=[("itm_linen_cloth_small", 2)], tailoring=2)),
  ("pn_buy_russian_kyiv_dragoons_all", spr_buy_item_flags(6), "rus_kyiv_dragoons_all", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_kyiv_dragoons_all", resources=["itm_iron_bar", "itm_copper_piece"], engineer=7)),
  ("pn_buy_russian_kyiv_dragoons_trumpeter", spr_buy_item_flags(6), "rus_kyiv_dragoons_trumpeter", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_kyiv_dragoons_trumpeter", resources=["itm_iron_bar", "itm_copper_piece"], engineer=7)),
  ("pn_buy_russian_drummer_shako", spr_buy_item_flags(3), "rus_drummer_shako", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_drummer_shako", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_russian_chevalier_hat", spr_buy_item_flags(6), "rus_chevalier_hat", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_chevalier_hat", resources=["itm_iron_bar", "itm_copper_piece"], engineer=7)),
  ("pn_buy_russian_chevalier_hat_officer", spr_buy_item_flags(6), "rus_chevalier_hat_off", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_chevalier_hat_officer", resources=["itm_iron_bar", "itm_copper_piece"], engineer=7)),
  ("pn_buy_russian_chevalier_hat_trumpeter", spr_buy_item_flags(6), "rus_chevalier_hat_trump", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_chevalier_hat_trumpeter", resources=["itm_iron_bar", "itm_copper_piece"], engineer=7)),
  ("pn_buy_russian_arty_shako_officer", spr_buy_item_flags(3), "rus_arty_captain_shako", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_arty_shako_officer", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_russian_arty_shako_nco", spr_buy_item_flags(3), "rus_arty_sarge_shako", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_arty_shako_nco", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_russian_arty_shako_ranker", spr_buy_item_flags(3), "rus_arty_ranker_shako", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_arty_shako_ranker", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_russian_cossack_hat_officer", spr_buy_item_flags(4), "rus_cossacks_captain_hat", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_cossack_hat_officer", resources=[("itm_leather_piece", 2), "itm_linen_cloth_small"], tailoring=2)),
  ("pn_buy_russian_cossack_hat_nco", spr_buy_item_flags(4), "rus_cossacks_sarge_hat", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_cossack_hat_nco", resources=[("itm_leather_piece", 2), "itm_linen_cloth_small"], tailoring=2)),
  ("pn_buy_russian_cossack_hat_ranker", spr_buy_item_flags(2), "rus_cossacks_ranker_hat", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_cossack_hat_ranker", resources=["itm_linen_cloth_small"], tailoring=2)),
  ("pn_buy_russian_hussar_shako_officer", spr_buy_item_flags(3), "rus_hussard_captain_shako", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_hussar_shako_officer", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_russian_hussar_shako_nco", spr_buy_item_flags(3), "rus_hussard_sarge_shako", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_hussar_shako_nco", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_russian_hussar_shako_ranker", spr_buy_item_flags(3), "rus_hussard_ranker_shako", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_hussar_shako_ranker", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_russian_hussar_shako_trumpeter", spr_buy_item_flags(3), "rus_hussard_trumpeter_shako", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_hussar_shako_trumpeter", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_russian_jaeger_shako_nco", spr_buy_item_flags(3), "rus_jaeger_sarge_shako", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_jaeger_shako_nco", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_russian_jaeger_shako_ranker", spr_buy_item_flags(3), "rus_jaeger_ranker_shako", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_jaeger_shako_ranker", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_russian_kutuzov_hat", spr_buy_item_flags(1), "rus_general", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_kutuzov_hat", resources=["itm_linen_thread"], tailoring=1)),
  ("pn_buy_russian_guard_shako_officer", spr_buy_item_flags(3), "rus_preobr_captain_shako", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_guard_shako_officer", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_russian_guard_shako_nco", spr_buy_item_flags(3), "rus_preobr_sarge_shako", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_guard_shako_nco", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_russian_guard_shako_ranker", spr_buy_item_flags(3), "rus_preobr_ranker_shako", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_guard_shako_ranker", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_russian_guard_shako_musician", spr_buy_item_flags(3), "rus_preobr_musician_shako", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_guard_shako_musician", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_russian_infantry_officer_shako", spr_buy_item_flags(3), "rus_captain_jaeger_musketeer_shako", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_infantry_officer_shako", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_russian_infantry_shako_nco", spr_buy_item_flags(3), "rus_musketeer_sarge_shako", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_infantry_shako_nco", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_russian_pioneer_shako", spr_buy_item_flags(3), "shako_rus_pioneer", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_pioneer_shako", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_russian_uhlan_czapka_officer", spr_buy_item_flags(5), "czapka_officer_uhlan", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_uhlan_czapka_officer", resources=[("itm_leather_piece", 2), ("itm_linen_cloth_small", 2)], tailoring=2)),
  ("pn_buy_russian_uhlan_czapka_nco", spr_buy_item_flags(5), "czapka_nco_uhlan", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_uhlan_czapka_nco", resources=[("itm_leather_piece", 2), ("itm_linen_cloth_small", 2)], tailoring=2)),
  ("pn_buy_russian_uhlan_czapka_ranker", spr_buy_item_flags(5), "czapka_ranker_uhlan", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_uhlan_czapka_ranker", resources=[("itm_leather_piece", 2), ("itm_linen_cloth_small", 2)], tailoring=2)),
  ("pn_buy_russian_uhlan_czapka_trumpeter", spr_buy_item_flags(5), "czapka_trump_uhlan", "bo_pw_armor_head", spr_buy_item_triggers("itm_rus_uhlan_czapka_trumpeter", resources=[("itm_leather_piece", 2), ("itm_linen_cloth_small", 2)], tailoring=2)),
  ...
  ("pn_buy_austrian_arty_bicorn", spr_buy_item_flags(3), "aus_arty_bicorn", "bo_pw_armor_head", spr_buy_item_triggers("itm_aus_arty_bicorn", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_austrian_arty_cap_bicorn", spr_buy_item_flags(3), "aus_arty_cap_bicorn", "bo_pw_armor_head", spr_buy_item_triggers("itm_aus_arty_cap_bicorn", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_austrian_arty_train_hat", spr_buy_item_flags(3), "aus_arty_train_hat", "bo_pw_armor_head", spr_buy_item_triggers("itm_aus_arty_train_hat", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_austrian_cavalry_helmet_officer", spr_buy_item_flags(6), "aus_cavalry_helmet_officer", "bo_pw_armor_head", spr_buy_item_triggers("itm_aus_cavalry_helmet_officer", resources=["itm_iron_bar", "itm_copper_piece"], engineer=7)),
  ("pn_buy_austrian_cavalry_helmet_ranker", spr_buy_item_flags(6), "aus_cavalry_helmet_ranker", "bo_pw_armor_head", spr_buy_item_triggers("itm_aus_cavalry_helmet_ranker", resources=["itm_iron_bar", "itm_copper_piece"], engineer=7)),
  ("pn_buy_austrian_cavalry_helmet_trumpeter", spr_buy_item_flags(6), "aus_cavalry_helmet_trumpeter", "bo_pw_armor_head", spr_buy_item_triggers("itm_aus_cavalry_helmet_trumpeter", resources=["itm_iron_bar", "itm_copper_piece"], engineer=7)),
  ("pn_buy_austrian_uhlan_czapka", spr_buy_item_flags(5), "aus_uhlan_czapka", "bo_pw_armor_head", spr_buy_item_triggers("itm_aus_uhlan_czapka", resources=[("itm_leather_piece", 2), ("itm_linen_cloth_small", 2)], tailoring=2)),
  ("pn_buy_austrian_uhlan_czapka_officer", spr_buy_item_flags(5), "aus_uhlan_czapka_officer", "bo_pw_armor_head", spr_buy_item_triggers("itm_aus_uhlan_czapka_officer", resources=[("itm_leather_piece", 2), ("itm_linen_cloth_small", 2)], tailoring=2)),
  ("pn_buy_austrian_uhlan_czapka_trumpeter", spr_buy_item_flags(5), "aus_uhlan_czapka_trumpeter", "bo_pw_armor_head", spr_buy_item_triggers("itm_aus_uhlan_czapka_trumpeter", resources=[("itm_leather_piece", 2), ("itm_linen_cloth_small", 2)], tailoring=2)),
  ("pn_buy_austrian_shwarzenberg_bicorn", spr_buy_item_flags(6), "aus_shwarzenberg_bicorn", "bo_pw_armor_head", spr_buy_item_triggers("itm_aus_shwarzenberg_bicorn", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_austrian_grenadier_bearskin", spr_buy_item_flags(4), "aus_grenadier_bearskin", "bo_pw_armor_head", spr_buy_item_triggers("itm_aus_grenadier_bearskin", resources=[("itm_leather_piece", 2), "itm_linen_cloth_small"], tailoring=2)),
  ("pn_buy_austrian_grenadier_bearskin_officer", spr_buy_item_flags(4), "aus_grenadier_bearskin_officer", "bo_pw_armor_head", spr_buy_item_triggers("itm_aus_grenadier_bearskin_officer", resources=[("itm_leather_piece", 2), "itm_linen_cloth_small"], tailoring=2)),
  ("pn_buy_austrian_tyrol_hat", spr_buy_item_flags(3), "aus_tyrol_hat", "bo_pw_armor_head", spr_buy_item_triggers("itm_aus_tyrol_hat", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_austrian_tyrol_hat_officer", spr_buy_item_flags(3), "aus_tyrol_hat_officer", "bo_pw_armor_head", spr_buy_item_triggers("itm_aus_tyrol_hat_officer", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_austrian_pioneer_hat", spr_buy_item_flags(3), "aus_pioneer_hat", "bo_pw_armor_head", spr_buy_item_triggers("itm_aus_pioneer_hat", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_austrian_grenzer_officer", spr_buy_item_flags(3), "aus_grenzer_officer", "bo_pw_armor_head", spr_buy_item_triggers("itm_aus_grenzer_officer", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_austrian_grenzer_ranker", spr_buy_item_flags(3), "aus_grenzer_ranker", "bo_pw_armor_head", spr_buy_item_triggers("itm_aus_grenzer_ranker", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_austrian_infantry_nco", spr_buy_item_flags(3), "aus_infantry_nco", "bo_pw_armor_head", spr_buy_item_triggers("itm_aus_infantry_nco", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_austrian_infantry_officer", spr_buy_item_flags(3), "aus_infantry_officer", "bo_pw_armor_head", spr_buy_item_triggers("itm_aus_infantry_officer", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_austrian_infantry_ranker", spr_buy_item_flags(3), "aus_infantry_ranker", "bo_pw_armor_head", spr_buy_item_triggers("itm_aus_infantry_ranker", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_austrian_hussard_shako_nco", spr_buy_item_flags(3), "aus_hussard_shako_nco", "bo_pw_armor_head", spr_buy_item_triggers("itm_aus_hussard_shako_nco", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_austrian_hussard_shako_officer", spr_buy_item_flags(3), "aus_hussard_shako_officer", "bo_pw_armor_head", spr_buy_item_triggers("itm_aus_hussard_shako_officer", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_austrian_hussard_shako_ranker", spr_buy_item_flags(3), "aus_hussard_shako_ranker", "bo_pw_armor_head", spr_buy_item_triggers("itm_aus_hussard_shako_ranker", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_austrian_hussard_shako_trumpeter", spr_buy_item_flags(3), "aus_hussard_shako_trumpeter", "bo_pw_armor_head", spr_buy_item_triggers("itm_aus_hussard_shako_trumpeter", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_austrian_surgeon_hat", spr_buy_item_flags(3), "austria_surgeon_hat", "bo_pw_armor_head", spr_buy_item_triggers("itm_aus_surgeon_hat", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ...
  ("pn_buy_french_arty_captain_bottefortes", spr_buy_item_flags(6), "fr_arty_captain_bottefortes", "bo_pw_armor_foot", spr_buy_item_triggers("itm_fr_arty_captain_bottefortes", resources=["itm_leather_roll", "itm_linen_cloth"], tailoring=2)),
  ("pn_buy_french_arty_train_bottefortes", spr_buy_item_flags(6), "fr_arty_train_bottefortes", "bo_pw_armor_foot", spr_buy_item_triggers("itm_fr_arty_train_bottefortes", resources=["itm_leather_roll", "itm_linen_cloth"], tailoring=2)),
  ("pn_buy_french_officer_bottefortes", spr_buy_item_flags(6), "fr_officer_bottefortes", "bo_pw_armor_foot", spr_buy_item_triggers("itm_fr_officer_bottefortes", resources=["itm_leather_roll", "itm_linen_cloth"], tailoring=2)),
  ...
  ("pn_buy_russian_infantry_pants1", spr_buy_item_flags(4), "rus_musketeer_pants1", "bo_pw_armor_foot", spr_buy_item_triggers("itm_rus_infantry_pants1", resources=[("itm_leather_piece", 2), "itm_linen_cloth"], tailoring=2)),
  ("pn_buy_russian_infantry_pants2", spr_buy_item_flags(4), "rus_musketeer_pants2", "bo_pw_armor_foot", spr_buy_item_triggers("itm_rus_infantry_pants2", resources=[("itm_leather_piece", 2), "itm_linen_cloth"], tailoring=2)),
  ("pn_buy_russian_hussar_pants1", spr_buy_item_flags(4), "rus_hussar_pants1", "bo_pw_armor_foot", spr_buy_item_triggers("itm_rus_hussar_pants1", resources=[("itm_leather_piece", 2), "itm_linen_cloth"], tailoring=2)),
  ("pn_buy_russian_hussar_pants2", spr_buy_item_flags(4), "rus_hussar_pants2", "bo_pw_armor_foot", spr_buy_item_triggers("itm_rus_hussar_pants2", resources=[("itm_leather_piece", 2), "itm_linen_cloth"], tailoring=2)),
  ("pn_buy_russian_hussar_pants_nco", spr_buy_item_flags(4), "rus_hussards_sarg_pants", "bo_pw_armor_foot", spr_buy_item_triggers("itm_rus_hussar_pants_nco", resources=[("itm_leather_piece", 2), "itm_linen_cloth"], tailoring=2)),
  ("pn_buy_russian_hussar_pants_officer", spr_buy_item_flags(4), "rus_hussards_off_pants", "bo_pw_armor_foot", spr_buy_item_triggers("itm_rus_hussar_pants_officer", resources=[("itm_leather_piece", 2), "itm_linen_cloth"], tailoring=2)),
  ("pn_buy_russian_horse_guard_pants", spr_buy_item_flags(6), "rus_chevalier_pants", "bo_pw_armor_foot", spr_buy_item_triggers("itm_rus_horse_guard_pants", resources=["itm_leather_roll", "itm_linen_cloth"], tailoring=2)),
  ("pn_buy_russian_cossack_off_pants", spr_buy_item_flags(3), "rus_cossack_off_pants", "bo_pw_armor_foot", spr_buy_item_triggers("itm_rus_cossack_off_pants", resources=["itm_leather_piece", "itm_linen_cloth"], tailoring=2)),
  ("pn_buy_russian_kutuzov_pants", spr_buy_item_flags(6), "rus_kutuzov_pants", "bo_pw_armor_foot", spr_buy_item_triggers("itm_rus_kutuzov_pants", resources=["itm_leather_roll", "itm_linen_cloth"], tailoring=2)),
  ("pn_buy_russian_militia_off_pants", spr_buy_item_flags(2), "rus_militia_off_pants", "bo_pw_armor_foot", spr_buy_item_triggers("itm_rus_militia_off_pants", resources=[("itm_leather_piece", 2)], tailoring=2)),
  ("pn_buy_russian_jaeger_pants", spr_buy_item_flags(4), "rus_jaeger_pants", "bo_pw_armor_foot", spr_buy_item_triggers("itm_rus_jaeger_pants", resources=[("itm_leather_piece", 2), "itm_linen_cloth"], tailoring=2)),
  ("pn_buy_russian_arty_pants", spr_buy_item_flags(4), "rus_arty_pants", "bo_pw_armor_foot", spr_buy_item_triggers("itm_rus_arty_pants", resources=[("itm_leather_piece", 2), "itm_linen_cloth"], tailoring=2)),
  ("pn_buy_russian_dragoon_pants1", spr_buy_item_flags(3), "rus_dragoon_pants1", "bo_pw_armor_foot", spr_buy_item_triggers("itm_rus_dragoon_pants1", resources=["itm_leather_piece", "itm_linen_cloth"], tailoring=2)),
  ("pn_buy_russian_dragoon_pants2", spr_buy_item_flags(3), "rus_dragoon_pants2", "bo_pw_armor_foot", spr_buy_item_triggers("itm_rus_dragoon_pants2", resources=["itm_leather_piece", "itm_linen_cloth"], tailoring=2)),
  ("pn_buy_russian_uhlan_pants", spr_buy_item_flags(4), "russian_uhlan_pants", "bo_pw_armor_foot", spr_buy_item_triggers("itm_rus_uhlan_pants", resources=[("itm_leather_piece", 2), "itm_linen_cloth"], tailoring=2)),
  ...
  ("pn_buy_austrian_hungarian_pants", spr_buy_item_flags(3), "austrian_hungarian_pants", "bo_pw_armor_foot", spr_buy_item_triggers("itm_hungarian_pants", resources=["itm_leather_piece", "itm_linen_cloth"], tailoring=2)),
  ("pn_buy_austrian_hungarian_pants_officer", spr_buy_item_flags(4), "austrian_hungarian_officer_boots", "bo_pw_armor_foot", spr_buy_item_triggers("itm_hungarian_pants_officer", resources=[("itm_leather_piece", 2), "itm_linen_cloth"], tailoring=2)),
  ...
  ("pn_buy_austrian_hungarian_hussar_pants", spr_buy_item_flags(4), "austrian_hussard_pants", "bo_pw_armor_foot", spr_buy_item_triggers("itm_hungarian_hussar_pants", resources=[("itm_leather_piece", 2), "itm_linen_cloth"], tailoring=2)),
  ("pn_buy_austrian_hungarian_uhlan_pants", spr_buy_item_flags(4), "austrian_uhlan_pants", "bo_pw_armor_foot", spr_buy_item_triggers("itm_hungarian_uhlan_pants", resources=[("itm_leather_piece", 2), "itm_linen_cloth"], tailoring=2)),
  ...
  # GLOVES
  ("pn_buy_gloves_officer", spr_buy_item_flags(2), "officer_gloves_L", "bo_pw_armor_hand", spr_buy_item_triggers  ("itm_gloves_officer", resources=["itm_linen_cloth_small"], tailoring=1)),
  ("pn_buy_gloves_drummer", spr_buy_item_flags(2), "drummer_gloves_L", "bo_pw_armor_hand", spr_buy_item_triggers  ("itm_gloves_drummer", resources=["itm_linen_cloth_small"], tailoring=1)),
  ("pn_buy_gloves_cuirassier", spr_buy_item_flags(4), "fr_cavalry_glove_L", "bo_pw_armor_hand", spr_buy_item_triggers  ("itm_gloves_cuirassier", resources=["itm_linen_cloth_small", "itm_leather_piece"], tailoring=2)),
  ("pn_buy_gloves_artillery", spr_buy_item_flags(4), "glove_black_L", "bo_pw_armor_hand", spr_buy_item_triggers  ("itm_gloves_artillery", resources=["itm_linen_cloth_small", "itm_leather_piece"], tailoring=2)),
  ("pn_buy_gloves_cavalry", spr_buy_item_flags(4), "white_cavalry_glove_L", "bo_pw_armor_hand", spr_buy_item_triggers  ("itm_gloves_cavalry", resources=["itm_linen_cloth_small", "itm_leather_piece"], tailoring=2)),
  ("pn_buy_gloves_horseguard", spr_buy_item_flags(4), "hg_cavalry_glove_L", "bo_pw_armor_hand", spr_buy_item_triggers  ("itm_gloves_horseguard", resources=["itm_linen_cloth_small", "itm_leather_piece"], tailoring=2)),
  ("pn_buy_gloves_cavalry_short", spr_buy_item_flags(2), "white_cavalry_glove_short_L", "bo_pw_armor_hand", spr_buy_item_triggers  ("itm_gloves_cavalry_short", resources=["itm_linen_cloth_small"], tailoring=1)),
  ("pn_buy_gloves_horseguard_short", spr_buy_item_flags(2), "hg_cavalry_glove_short_L", "bo_pw_armor_hand", spr_buy_item_triggers("itm_gloves_horseguard_short", resources=["itm_linen_cloth_small"], tailoring=1)),
  ...
  # Especial
  ("pn_change_troop_emperor",spr_use_time(120),"pn_crown_training_station","bo_pw_weapon_small", spr_change_troop_triggers("trp_lord", cost=1000, use_string="str_troop_assume_role")),
  ...
  # Laigle props begin
  ("laigle_interior_drawingroom_a", 0, "laigle_drawingroom_euro", "bo_laigle_drawingroom_euro", []),
  ("laigle_interior_drawingroom_b", 0, "laigle_drawingroom_euro2", "bo_laigle_drawingroom_euro2", []),
  ("laigle_interior_drawingroom_c", 0, "laigle_drawingroom_euro3", "bo_laigle_drawingroom_euro3", []),
  ("laigle_interior_drawingroom_d", 0, "laigle_drawingroom_euro4", "bo_laigle_drawingroom_euro4", []),
  ("laigle_interior_drawingroom_e", 0, "laigle_drawingroom_euro5", "bo_laigle_drawingroom_euro5", []),
  ("laigle_interior_drawingroom_f", 0, "laigle_drawingroom_euro6", "bo_laigle_drawingroom_euro6", []),
  ("laigle_interior_drawingroom_g", 0, "laigle_drawingroom_euro7", "bo_laigle_drawingroom_euro7", []),
  ("laigle_interior_drawingroom_h", 0, "laigle_drawingroom_euro8", "bo_laigle_drawingroom_euro8", []),
  ("laigle_interior_apartment_a", 0, "laigle_interior_apartment", "bo_laigle_interior_apartment", []),
  ("laigle_interior_apartment_b", 0, "laigle_interior_apartment2", "bo_laigle_interior_apartment2", []),
  ("laigle_interior_apartment_c", 0, "laigle_interior_apartment3", "bo_laigle_interior_apartment3", []),
  ("laigle_interior_beerhall_a", 0, "laigle_interior_beerhall", "bo_laigle_interior_beerhall", []),
  ("laigle_interior_beerhall_b", 0, "laigle_interior_beerhall2", "bo_laigle_interior_beerhall2", []),
  ("laigle_interior_cornerclub_a", 0, "laigle_interior_cornerclub", "bo_laigle_interior_cornerclub", []),
  ("laigle_interior_cornerclub_b", 0, "laigle_interior_cornerclub2", "bo_laigle_interior_cornerclub2", []),
  ("laigle_interior_plainhouse", 0, "laigle_interior_plainhouse", "bo_laigle_interior_plainhouse", []),
  ("laigle_interior_pub_a", 0, "laigle_interior_pub", "bo_laigle_interior_pub", []),
  ...
  ("laigle_bookcase_opened", 0, "laigle_prop_bookcase_open", "bo_laigle_prop_bookcase_open", []),
  ("laigle_candelabrum", 0, "laigle_prop_candelabrum", "0", []),
  ("laigle_candlestick_a", 0, "laigle_prop_candlestick", "0", []),
  ("laigle_candlestick_b", 0, "laigle_prop_candlestick_brass", "0", []),
  ("laigle_chandelier_fancy", 0, "laigle_prop_chandelier_fancy", "bo_laigle_prop_chandelier_fancy", []),
  ("laigle_curtains", 0, "laigle_prop_curtains", "0", []),
  ("laigle_desk_velvet_red", 0, "laigle_prop_desk_velvet", "bo_laigle_prop_desk_velvet", []),
  ("laigle_desk_velvet_green", 0, "laigle_prop_desk_velvet_white", "bo_laigle_prop_desk_velvet_white", []),
  ("laigle_bottle_green", 0, "laigle_prop_dishes_bottle", "0", []),
  ("laigle_bottle_brown", 0, "laigle_prop_dishes_bottlebrown", "0", []),
  ("laigle_cup", 0, "laigle_prop_dishes_cup", "0", []),
  ("laigle_jar", 0, "laigle_prop_dishes_jar", "0", []),
  ("laigle_plate_a", 0, "laigle_prop_dishes_plate", "0", []),
  ("laigle_plate_b", 0, "laigle_prop_dishes_plateporcelain", "0", []),
  ("laigle_fancymirror", 0, "laigle_prop_fancymirror", "0", []),
  ("laigle_goldchair_red", 0, "laigle_prop_goldchair", "bo_laigle_prop_goldchair", []),
  ("laigle_goldchair_green", 0, "laigle_prop_goldchair_white", "bo_laigle_prop_goldchair_white", []),
  ("laigle_lamp_a", 0, "laigle_prop_lamp", "0", []),
  ...
  ("laigle_outside_bench", 0, "laigle_prop_outside_bench", "bo_laigle_prop_outside_bench", []),
  ("laigle_outside_table", 0, "laigle_prop_outside_table", "bo_laigle_prop_outside_table", []),
  ("laigle_painting_a", 0, "laigle_prop_painting_abuki", "0", []),
  ("laigle_painting_b", 0, "laigle_prop_painting_family", "0", []),
  ("laigle_painting_c", 0, "laigle_prop_painting_greco", "0", []),
  ("laigle_painting_d", 0, "laigle_prop_painting_landscape", "0", []),
  ("laigle_painting_e", 0, "laigle_prop_painting_landscape2", "0", []),
  ("laigle_painting_f", 0, "laigle_prop_painting_landscape3", "0", []),
  ("laigle_painting_g", 0, "laigle_prop_painting_landscape4", "0", []),
  ("laigle_painting_h", 0, "laigle_prop_painting_miniature", "0", []),
  ("laigle_painting_i", 0, "laigle_prop_painting_miniature2", "0", []),
  ("laigle_painting_j", 0, "laigle_prop_painting_miniature3", "0", []),
  ("laigle_painting_k", 0, "laigle_prop_painting_miniature4", "0", []),
  ("laigle_painting_l", 0, "laigle_prop_painting_portrait", "0", []),
  ("laigle_painting_m", 0, "laigle_prop_painting_portrait2", "0", []),
  ("laigle_painting_n", 0, "laigle_prop_painting_portrait3", "0", []),
  ("laigle_painting_o", 0, "laigle_prop_painting_sonnen", "0", []),
  ("laigle_table_velvet_red", 0, "laigle_prop_table_velvet", "bo_laigle_prop_table_velvet", []),
  ("laigle_table_velvet_green", 0, "laigle_prop_table_velvet_white", "bo_laigle_prop_table_velvet_white", []),
  ("laigle_tavern_bench", 0, "laigle_prop_tavern_bench", "bo_laigle_prop_tavern_bench", []),
  ("laigle_tavern_table", 0, "laigle_prop_tavern_table", "bo_laigle_prop_tavern_table", []),
  ("laigle_persiancarpet_a", 0, "laigle_persiancarpet", "0", []),
  ("laigle_persiancarpet_b", 0, "laigle_persiancarpet2", "0", []),
  ...
  ("city_hall_sign", 0, "city_hall_sign", "bo_tavern_sign", []),
  ("ground_prop_street_gray_bricks",0,"mm_ground_prop_street_bricks","bo_zaval", []),
  #PN END ***************************************************************************************************************************
