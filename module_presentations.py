  ...
  ("escape_menu", prsntf_manual_end_only, 0,
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (create_button_overlay, reg0, "str_menu_trade_routes", 0),
      (assign, "$g_presentation_obj_escape_menu_trade_routes", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),

      (create_button_overlay, reg0, "str_character_language", 0),
      (assign, "$g_presentation_obj_escape_menu_character_language", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (val_add, ":cur_y", escape_menu_item_height),
      ...
      (val_sub, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, "$g_presentation_obj_escape_menu_trade_routes", pos1),

      (val_sub, ":cur_y", escape_menu_item_height),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, "$g_presentation_obj_escape_menu_character_language", pos1),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      ...
      (else_try),
        (eq, ":object", "$g_presentation_obj_escape_menu_trade_routes"),
        (presentation_set_duration, 0),
        (start_presentation, "prsnt_trade_routes"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_escape_menu_character_language"),
        (presentation_set_duration, 0),
        (start_presentation, "prsnt_character_language"),
      (else_try),
   ...
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (try_begin),
        ...
        (create_button_overlay, reg0, "str_bring_player_here"),
        (assign, "$g_presentation_obj_admin_menu_teleport_play_here", reg0),
        (overlay_set_color, reg0, 0xFFFFFF),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
      ...
      (else_try),
        ...
        (assign, "$g_presentation_obj_admin_menu_teleport_play_here", -1),
      (try_end),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      ...
      (else_try),
        (eq, ":object", "$g_presentation_obj_admin_menu_teleport_play_here"),
        (assign, ":action", admin_action_teleport_player_here),
        (assign, "$g_list_players_action_string_id", "str_bring_player_here"),
      (else_try),
...
presentations.extend([
  ...
  ("trade_routes", prsntf_manual_end_only, 0,
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),

      (call_script, "script_client_request_all_trade_routes_owning_factions"),
      ...
      (store_mul, ":spacing", 2, escape_menu_item_height),
      (val_add, ":spacing", 15),

      # Coffee
      (try_for_prop_instances, ":trade_route", "spr_pn_trade_route_coffee_capture_point"),
        (prop_instance_is_valid, ":trade_route"),
        (call_script, "script_build_trade_route_menu_details", ":trade_route"),
        (create_text_overlay, reg0, "str_trade_route_details_menu", 0),
        (overlay_set_color, reg0, 0xD7B598),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
        (val_add, ":cur_y", ":spacing"),
      (try_end),
      # Cotton
      (try_for_prop_instances, ":trade_route", "spr_pn_trade_route_cotton_capture_point"),
        (prop_instance_is_valid, ":trade_route"),
        (call_script, "script_build_trade_route_menu_details", ":trade_route"),
        (create_text_overlay, reg0, "str_trade_route_details_menu", 0),
        (overlay_set_color, reg0, 0xFFFFFF),
      ...
      (try_end),
      # Fur
      (try_for_prop_instances, ":trade_route", "spr_pn_trade_route_fur_capture_point"),
        (prop_instance_is_valid, ":trade_route"),
        (call_script, "script_build_trade_route_menu_details", ":trade_route"),
        (create_text_overlay, reg0, "str_trade_route_details_menu", 0),
        (overlay_set_color, reg0, 0xCDC7BC),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
        (val_add, ":cur_y", ":spacing"),
      (try_end),
      # Ivory
      (try_for_prop_instances, ":trade_route", "spr_pn_trade_route_ivory_capture_point"),
        (prop_instance_is_valid, ":trade_route"),
        (call_script, "script_build_trade_route_menu_details", ":trade_route"),
        (create_text_overlay, reg0, "str_trade_route_details_menu", 0),
        (overlay_set_color, reg0, 0xF5F2E7),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
        (val_add, ":cur_y", ":spacing"),
      (try_end),
      # Spices
      (try_for_prop_instances, ":trade_route", "spr_pn_trade_route_spices_capture_point"),
        (prop_instance_is_valid, ":trade_route"),
        (call_script, "script_build_trade_route_menu_details", ":trade_route"),
        (create_text_overlay, reg0, "str_trade_route_details_menu", 0),
        (overlay_set_color, reg0, 0xED5269),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
        (val_add, ":cur_y", ":spacing"),
      (try_end),
      # Sugar
      (try_for_prop_instances, ":trade_route", "spr_pn_trade_route_sugar_capture_point"),
        (prop_instance_is_valid, ":trade_route"),
        (call_script, "script_build_trade_route_menu_details", ":trade_route"),
        (create_text_overlay, reg0, "str_trade_route_details_menu", 0),
        (overlay_set_color, reg0, 0xFFFFFF),
      ...
      (try_end),
      # Tea
      (try_for_prop_instances, ":trade_route", "spr_pn_trade_route_tea_capture_point"),
        (prop_instance_is_valid, ":trade_route"),
        (call_script, "script_build_trade_route_menu_details", ":trade_route"),
        (create_text_overlay, reg0, "str_trade_route_details_menu", 0),
        (overlay_set_color, reg0, 0xCBD592),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
        (val_add, ":cur_y", ":spacing"),
      (try_end),
      # Tobacco
      (try_for_prop_instances, ":trade_route", "spr_pn_trade_route_tobacco_capture_point"),
        (prop_instance_is_valid, ":trade_route"),
        (call_script, "script_build_trade_route_menu_details", ":trade_route"),
        (create_text_overlay, reg0, "str_trade_route_details_menu", 0),
        (overlay_set_color, reg0, 0xD2BAAD),
        (overlay_set_size, reg0, pos2),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
        (val_add, ":cur_y", ":spacing"),
  ...
  ("character_language", prsntf_manual_end_only, 0,
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (create_button_overlay, reg0, "str_character_language_french"),
      (assign, "$g_presentation_obj_language_french", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, reg0, pos1),
      ...
      (create_button_overlay, reg0, "str_character_language_english"),
      (assign, "$g_presentation_obj_language_english", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, reg0, pos1),
      ...
      (create_button_overlay, reg0, "str_character_language_prussian"),
      (assign, "$g_presentation_obj_language_prussian", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, reg0, pos1),
      ...
      (create_button_overlay, reg0, "str_character_language_austrian"),
      (assign, "$g_presentation_obj_language_austrian", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, reg0, pos1),
      ...
      (create_button_overlay, reg0, "str_character_language_russian"),
      (assign, "$g_presentation_obj_language_russian", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, reg0, pos1),
      ...
      (create_button_overlay, reg0, "str_character_language_pirate"),
      (assign, "$g_presentation_obj_language_pirate", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, reg0, pos1),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      ...
      (try_begin),
        (eq, ":object", "$g_presentation_obj_language_french"),
        (agent_set_slot, ":my_agent", slot_agent_character_language, player_character_language_french),
        (multiplayer_send_2_int_to_server, client_event_change_character_language, player_character_language_french),
      (else_try),
        (eq, ":object", "$g_presentation_obj_language_english"),
        (agent_set_slot, ":my_agent", slot_agent_character_language, player_character_language_english),
        (multiplayer_send_2_int_to_server, client_event_change_character_language, player_character_language_english),
      (else_try),
        (eq, ":object", "$g_presentation_obj_language_prussian"),
        (agent_set_slot, ":my_agent", slot_agent_character_language, player_character_language_prussian),
        (multiplayer_send_2_int_to_server, client_event_change_character_language, player_character_language_prussian),
      (else_try),
        (eq, ":object", "$g_presentation_obj_language_austrian"),
        (agent_set_slot, ":my_agent", slot_agent_character_language, player_character_language_austrian),
        (multiplayer_send_2_int_to_server, client_event_change_character_language, player_character_language_austrian),
      (else_try),
        (eq, ":object", "$g_presentation_obj_language_russian"),
        (agent_set_slot, ":my_agent", slot_agent_character_language, player_character_language_russian),
        (multiplayer_send_2_int_to_server, client_event_change_character_language, player_character_language_russian),
      (else_try),
        (eq, ":object", "$g_presentation_obj_language_pirate"),
        (agent_set_slot, ":my_agent", slot_agent_character_language, player_character_language_pirate),
        (multiplayer_send_2_int_to_server, client_event_change_character_language, player_character_language_pirate),
      (try_end),
      (presentation_set_duration, 0),
      ]),
    (ti_on_presentation_run,
  ...
  ("orders_menu", prsntf_manual_end_only|prsntf_read_only, 0, [
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (create_button_overlay, reg1, "str_comm_menu_follow_me"),
      (assign, "$g_presentation_obj_order_follow_me", reg1),
      (overlay_set_color, reg1, 0xFFFFFF),
      (position_set_x, pos1, 10),
      (position_set_y, pos1, ":y_pos"),
      (overlay_set_position, reg1, pos1),
      ...
      (create_button_overlay, reg1, "str_comm_menu_hold_position"),
      (assign, "$g_presentation_obj_order_hold_position", reg1),
      (overlay_set_color, reg1, 0xFFFFFF),
      (position_set_x, pos1, 10),
      (position_set_y, pos1, ":y_pos"),
      (overlay_set_position, reg1, pos1),
      ...
      (create_button_overlay, reg1, "str_comm_menu_advance"),
      (assign, "$g_presentation_obj_order_advance", reg1),
      (overlay_set_color, reg1, 0xFFFFFF),
      (position_set_x, pos1, 10),
      (position_set_y, pos1, ":y_pos"),
      (overlay_set_position, reg1, pos1),
      ...
      (create_button_overlay, reg1, "str_comm_menu_presents"),
      (assign, "$g_presentation_obj_order_presents", reg1),
      (overlay_set_color, reg1, 0xFFFFFF),
      (position_set_x, pos1, 10),
      (position_set_y, pos1, ":y_pos"),
      (overlay_set_position, reg1, pos1),
      ...
      (create_button_overlay, reg1, "str_comm_menu_ready"),
      (assign, "$g_presentation_obj_order_ready", reg1),
      (overlay_set_color, reg1, 0xFFFFFF),
      (position_set_x, pos1, 10),
      (position_set_y, pos1, ":y_pos"),
      (overlay_set_position, reg1, pos1),
      ...
      (create_button_overlay, reg1, "str_comm_menu_fire"),
      (assign, "$g_presentation_obj_order_fire", reg1),
      (overlay_set_color, reg1, 0xFFFFFF),
      (position_set_x, pos1, 10),
      (position_set_y, pos1, ":y_pos"),
      (overlay_set_position, reg1, pos1),
      ...
      (create_button_overlay, reg1, "str_comm_menu_fire_at_will"),
      (assign, "$g_presentation_obj_order_fire_at_will", reg1),
      (overlay_set_color, reg1, 0xFFFFFF),
      (position_set_x, pos1, 10),
      (position_set_y, pos1, ":y_pos"),
      (overlay_set_position, reg1, pos1),
      ...
      (create_button_overlay, reg1, "str_comm_menu_charge"),
      (assign, "$g_presentation_obj_order_charge", reg1),
      (overlay_set_color, reg1, 0xFFFFFF),
      (position_set_x, pos1, 10),
      (position_set_y, pos1, ":y_pos"),
      (overlay_set_position, reg1, pos1),
      ...
      (create_button_overlay, reg1, "str_comm_menu_fall_back"),
      (assign, "$g_presentation_obj_order_fall_back", reg1),
      (overlay_set_color, reg1, 0xFFFFFF),
      (position_set_x, pos1, 10),
      (position_set_y, pos1, ":y_pos"),
      (overlay_set_position, reg1, pos1),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      (eq, ":object", "$g_presentation_obj_order_follow_me"),
        (try_begin),
          (clear_omitted_keys),
          (presentation_set_duration, 0),
        (try_end),
     ...
     [(store_trigger_param_1, ":current_time"),
      ...
      (else_try),
        ...
        (try_begin),
          (key_clicked, key_1),
          (clear_omitted_keys),
          (multiplayer_send_2_int_to_server, multiplayer_event_send_player_action, player_action_voice, voice_type_comm_on_me),
          (presentation_set_duration, 0),
        (else_try),
          (key_clicked, key_2),
          (clear_omitted_keys),
          (multiplayer_send_2_int_to_server, multiplayer_event_send_player_action, player_action_voice, voice_type_comm_hold),
          (presentation_set_duration, 0),
        (else_try),
          (key_clicked, key_3),
          (clear_omitted_keys),
          (multiplayer_send_2_int_to_server, multiplayer_event_send_player_action, player_action_voice, voice_type_comm_advance),
          (presentation_set_duration, 0),
        (else_try),
          (key_clicked, key_4),
          (clear_omitted_keys),
          (multiplayer_send_2_int_to_server, multiplayer_event_send_player_action, player_action_voice, voice_type_comm_present),
          (presentation_set_duration, 0),
        (else_try),
          (key_clicked, key_5),
          (clear_omitted_keys),
          (multiplayer_send_2_int_to_server, multiplayer_event_send_player_action, player_action_voice, voice_type_comm_ready),
          (presentation_set_duration, 0),
        (else_try),
          (key_clicked, key_6),
          (clear_omitted_keys),
          (multiplayer_send_2_int_to_server, multiplayer_event_send_player_action, player_action_voice, voice_type_comm_fire),
          (presentation_set_duration, 0),
        (else_try),
          (key_clicked, key_7),
          (clear_omitted_keys),
          (multiplayer_send_2_int_to_server, multiplayer_event_send_player_action, player_action_voice, voice_type_comm_fire_at_will),
          (presentation_set_duration, 0),
        (else_try),
          (key_clicked, key_8),
          (clear_omitted_keys),
          (multiplayer_send_2_int_to_server, multiplayer_event_send_player_action, player_action_voice, voice_type_comm_charge),
          (presentation_set_duration, 0),
        (else_try),
          (key_clicked, key_9),
          (clear_omitted_keys),
          (multiplayer_send_2_int_to_server, multiplayer_event_send_player_action, player_action_voice, voice_type_comm_fall_back),
          (presentation_set_duration, 0),
        (try_end),
      (try_end),
      ]),
  ...
  ("multiplayer_music", prsntf_manual_end_only, 0, [
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (else_try),  
        (agent_get_wielded_item, ":instrument", ":my_agent", 0),
      (try_end),
      ...
      (agent_get_slot, ":char_lang", ":my_agent", slot_agent_character_language),

      (try_begin),
        (eq,":instrument","itm_drumstick_right"),
        (try_begin),
          (this_or_next|eq,":char_lang", player_character_language_english),
          (eq,":char_lang", player_character_language_pirate),
        ...
        (else_try),
          (eq,":char_lang", player_character_language_french),
        ...
        (else_try),
          (eq,":char_lang", player_character_language_prussian),
        ...
        (else_try),
          (eq,":char_lang", player_character_language_russian),
        ...
        (else_try),
          (eq,":char_lang", player_character_language_austrian),
      ...
      (else_try),
        ...
        (try_begin),
          (eq,":char_lang", player_character_language_english),
  ...
  ("multiplayer_construct", prsntf_manual_end_only, 0, [(ti_on_presentation_load,
  [
    (set_fixed_point_multiplier, 1000),
    ...
    (try_for_range, ":prop_no", mm_construct_props_begin, mm_construct_props_end),
      ...
      (try_begin),
        (eq, ":cost_ok", 1),
        (create_text_overlay, reg0, "str_reg7_build_gold_cost", 0),
